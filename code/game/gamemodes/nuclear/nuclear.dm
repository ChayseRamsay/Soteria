...
/datum/game_mode/proc/equip_syndicate(mob/living/carbon/human/synd_mob)
	...
	if(synd_mob.backbag == 2) synd_mob.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/syndie(synd_mob), slot_back)
	if(synd_mob.backbag == 3) synd_mob.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel/syndie(synd_mob), slot_back)
	if(synd_mob.backbag == 4) synd_mob.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel(synd_mob), slot_back)
	if(synd_mob.backbag == 5) synd_mob.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/duffel/syndie(synd_mob), slot_back)
...
/datum/game_mode/nuclear/declare_completion()
	...
	if      (!disk_rescued &&  station_was_nuked &&          !syndies_didnt_escape)
		...
		feedback_set_details("round_end_result","halfwin - blew wrong ship")
		...
		feedback_set_details("round_end_result","halfwin - blew wrong ship - did not evacuate in time")
