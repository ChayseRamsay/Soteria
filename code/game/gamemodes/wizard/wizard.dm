...
/datum/game_mode/wizard/announce()
	...
	world << "<B>There is a \red SPACE WIZARD\black on the ship. You can't let him achieve his objective!</B>"
...
/datum/game_mode/proc/equip_wizard(mob/living/carbon/human/wizard_mob)
	...
	if(wizard_mob.backbag == 3) wizard_mob.equip_to_slot_or_del(new /obj/item/weapon/storage/backpack/satchel/wizard(wizard_mob), slot_back)
